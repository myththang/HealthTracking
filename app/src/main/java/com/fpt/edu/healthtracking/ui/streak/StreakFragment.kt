...
class StreakFragment : BaseFragment<StreakViewModel, FragmentStreakBinding, StreakRepository>() {
    ...
    private fun updateStreakUI(streakData: FoodStreakResponse) {
        binding.apply {
            if (streakData.streakNumber > 0) {
                val animator = ValueAnimator.ofInt(0, streakData.streakNumber)
            ...
            updateCalendarWithDates(streakData.dates)
        }
    }
    ...
    override fun getFragmentBinding(
        ...
        container: ViewGroup?
    ) = FragmentStreakBinding.inflate(inflater, container, false)
